...
<ul>
	...
	<div align="center"><h3>No results are found</h3></div>
		<%}
			...
			%>
	<h2  style="font-family:courier"><b>Payment Page:</b></h2>
	...
	<h4 style="font-family:courier"><b>To finish this deal, please enter your credit card number in the following box and submit!</b></h3>
	<form name="paynow" action="https://<%=request.getServerName()%>:8443<%=request.getContextPath()%>/confirmation" class="navbar-form navbar-left" method="POST" role="pay">
		<div class="form-group">
          <input type="text" name="ccn" class="form-control" placeholder="Enter your Credit Card Number">
        </div>
